...
public class TransformedMultipleServersTestCase extends MultipleServersTestCase {
	private static final String[] CT_INVALID_XSLTS = new String[] { "1fd26c94-6909-2222-9a75-685b35c84fb4",
			"1fd26c94-6909-1111-9a75-685b35c84fb4", "f260dfee-636c-4444-bbdd-685b35c84fb4",
			"f260dfee-636c-3333-bbdd-685b35c84fb4" };
	private static final String[] CT_RESULTS = new String[] { "files/sample1_3_1.html", "files/sample1_4_2.html",
			"files/sample2_2_3.html", "files/sample2_1_4.html" };
	private static final String[] CT_XMLS = new String[] { "ddcab7d0-636c-1111-8db3-685b35c84fb4",
			"ddcab7d0-636c-2222-8db3-685b35c84fb4", "ea118888-6908-3333-9620-685b35c84fb4",
			"ea118888-6908-4444-9620-685b35c84fb4" };
	private static final String[] CT_XSLTS = new String[] { "f260dfee-636c-3333-1111-685b35c84fb4",
			"f260dfee-636c-4444-2222-685b35c84fb4", "1fd26c94-6909-2222-3333-685b35c84fb4",
			"1fd26c94-6909-1111-4444-685b35c84fb4" };

	private final int serverIndex;

	public TransformedMultipleServersTestCase(String serverName, int serverIndex) {
		this.serverIndex = serverIndex;
	}

	protected String getResourceURL(String xmlUuid, String xsltUuid) {
		return String.format("%s/xml?uuid=%s&xslt=%s", serversHTTPURL[this.serverIndex], xmlUuid, xsltUuid);
	}
	...
	protected void testMultipleErrorGets(final String[] xmls, final String[] xslts, final int expectedError)
			throws IOException {
	...
	protected void testMultipleGets(final String[] xmls, final String[] xslts, final String[] expectedContents)
			throws IOException {
		for (int i = 0; i < xmls.length; i++) {
			final String xmlUuid = xmls[i];
			final String xsltUuid = xslts[i];
