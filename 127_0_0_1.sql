...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2019 at 09:43 AM
...
--
-- Indexes for table `xslt`
--
ALTER TABLE `xslt`
  ADD PRIMARY KEY (`uuid`),
  ADD KEY `FK_xslt_xsd` (`xsd`);
...
--
-- Constraints for table `xslt`
--
ALTER TABLE `xslt`
  ADD CONSTRAINT `FK_xslt_xsd` FOREIGN KEY (`xsd`) REFERENCES `xsd` (`uuid`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `hstestdb1`
--
